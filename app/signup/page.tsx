    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-100 via-emerald-50 to-green-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-8 border border-gray-100">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-extrabold bg-gradient-to-r from-green-700 to-green-500 bg-clip-text text-transparent">Create your account</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={formik.handleSubmit}>
          ...
          <div className="text-center text-sm">
            <p className="text-gray-600">
              ...
              <Link href="/signin" className="font-semibold text-green-600 hover:text-green-500">
                Sign in
              </Link>
            </p>
          </div>
